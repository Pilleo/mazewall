...
val generateKnowledgeMap by tasks.registering {
    ...
    doLast {
        class KnowledgeMapGenerator(private val rootDir: File) {
            ...
            private val targetMapFile = File(docsDir, "architecture/architectural-map.md")
            ...
            fun generate() {
                ...
                val designDocs = docsDir.walkTopDown()
                    .filter { it.isFile && it.name.endsWith(".md") && it.parentFile != mapsDir && !it.absolutePath.contains("/backlog/") }
                    .toList()
                    .sortedBy { it.name }
            ...
            private fun generateMermaidForScope(scopeName: String, designDocs: List<File>, backlogIssues: List<File>): String? {
                ...
                for (doc in designDocs) {
                    ...
                    if (filename in listOf("architecture/architectural-map.md", "architectural-map.md", "README.md", "documentation-standards.md", "documentation-standards.md")) {
                        continue
                    }
                    ...
                    val relPath = doc.relativeTo(docsDir).path
...
> Root map: [architectural-map.md](../architecture/architectural-map.md)
