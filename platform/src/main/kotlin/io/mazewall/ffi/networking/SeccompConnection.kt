 ...
 */
public sealed class SeccompConnection : AutoCloseable {
    ...
    public data class Accepted(
        ...
        public fun attachFd(listenerFd: FileDescriptor<FileDescriptorRole.SeccompNotif, FdState.Open>): FdAttached =
            FdAttached(socketFd, listenerFd).also { it.socketManager = this.socketManager }
    }
    ...
    public data class FdAttached(
        ...
        public fun handshakeComplete(): Active = Active(socketFd, listenerFd).also { it.socketManager = this.socketManager }
    }
