...
class "BillOfBehavior" as io.mazewall.profiler.BillOfBehavior {
  ...
  +Set<String> getExecs()
  +Map<SyscallEvent<Resolved>, List<StackTraceElement[]>> getStackProfile()
...
class "BobCompiler" as io.mazewall.profiler.compiler.BobCompiler {
  ...
  __
  +BillOfBehavior compile(List<? extends SyscallEvent<? extends Resolved>>)
}
...
class "ProfilerInstaller" as io.mazewall.profiler.engine.ProfilerInstaller {
  ...
  __
  +void installProfilingFilterForThread(String, Policy<?, ? extends Uncompiled>, List<SyscallEvent<Resolved>>, Map<SyscallEvent<Resolved>, List<StackTraceElement[]>>, Map<String, Long>, Function0<? extends Thread>, Function1<? super String, Integer>, Function5<? super Integer, ? super List<SyscallEvent<Resolved>>, ? super Map<SyscallEvent<Resolved>, List<StackTraceElement[]>>, ? super Map<String, Long>, ? super Function0<? extends Thread>, Unit>)
}
...
interface "ProfilerMemoryReader" as io.mazewall.profiler.engine.ProfilerMemoryReader {
  + {abstract}String readStringFromProcess-9xGxYpM(int, long, int)
  + {abstract}String resolveLink-av3ZdJY(int, String)
}
class "ProfilerSessionHandler" as io.mazewall.profiler.engine.ProfilerSessionHandler {
  + {static}Companion Companion
  __
  +SessionEventLedger getLedger()
...
class "RealMemoryReader" as io.mazewall.profiler.engine.RealMemoryReader {
  ...
  __
  +String readStringFromProcess-9xGxYpM(int, long, int)
  +String resolveLink-av3ZdJY(int, String)
}
...
interface "SeccompResponder" as io.mazewall.profiler.engine.SeccompResponder {
  ...
  + {abstract}void sendSeccompError(Failed, MemorySegment, int)
}
interface "SessionEvent" as io.mazewall.profiler.engine.SessionEvent {
  + {abstract}long getTimestampNanos()
  + {abstract}long getThreadId()
}
class "SessionEventLedger" as io.mazewall.profiler.engine.SessionEventLedger {
  + {static}Companion Companion
  __
  +void record(SessionEvent)
...
class "SyscallEvent" as io.mazewall.profiler.engine.SyscallEvent<S extends SyscallEventState> {
  ...
  +TraceEvent toTraceEvent()
}
class "SyscallEventKt" as io.mazewall.profiler.engine.SyscallEventKt {
  + {static}SyscallEvent<Resolved> resolved(SyscallEvent<? extends Raw>, List<String>)
}
interface "SyscallEventState" as io.mazewall.profiler.engine.SyscallEventState {
}
class "SyscallPathResolver" as io.mazewall.profiler.engine.SyscallPathResolver {
  +SyscallEvent<Resolved> resolve(SyscallEvent<? extends Raw>)
}
abstract class "TraceEvent" as io.mazewall.profiler.engine.TraceEvent {
  + {static}Companion Companion
  __
  + {abstract}int getPid()
  + {abstract}String getSyscallName()
  + {abstract}long[] getArgs()
...
io.mazewall.profiler.engine.ProfilerDaemonEngine --> io.mazewall.profiler.engine.SeccompResponder
io.mazewall.profiler.engine.ProfilerDaemonEngine --> io.mazewall.profiler.engine.ProfilerDaemonState
io.mazewall.profiler.engine.ProfilerDaemonEngine --> io.mazewall.profiler.engine.TraceEventPublisher
io.mazewall.profiler.engine.ProfilerDaemonEngine --> io.mazewall.profiler.engine.SocketLifecycleManager
io.mazewall.profiler.engine.ProfilerDaemonEngine --> io.mazewall.profiler.engine.NativeIoOperations
...
io.mazewall.profiler.engine.ProfilerInstallerSession --> io.mazewall.profiler.engine.SyscallEvent
io.mazewall.profiler.engine.ProfilerInstallerSession --> io.mazewall.profiler.engine.ProfilerInstallerState
io.mazewall.profiler.engine.ProfilerSessionHandler --> io.mazewall.profiler.engine.SeccompResponder
io.mazewall.profiler.engine.ProfilerSessionHandler --> io.mazewall.profiler.engine.ProfilerState
io.mazewall.profiler.engine.ProfilerSessionHandler --> io.mazewall.profiler.engine.TraceEventPublisher
io.mazewall.profiler.engine.ProfilerSessionHandler --> io.mazewall.profiler.engine.SessionEventLedger
io.mazewall.profiler.engine.ProfilerSessionHandler --> io.mazewall.profiler.engine.NativeIoOperations
io.mazewall.profiler.engine.ProfilerSessionHandler --> io.mazewall.profiler.engine.ProfilerMemoryReader
io.mazewall.profiler.engine.ProfilerTransport .u.|> io.mazewall.profiler.engine.TraceEventPublisher
io.mazewall.profiler.engine.ProfilerTransport .u.|> io.mazewall.profiler.engine.SeccompResponder
io.mazewall.profiler.engine.ProfilerTransport .u.|> io.mazewall.profiler.engine.NativeIoOperations
io.mazewall.profiler.engine.ProfilerTransport .u.|> io.mazewall.profiler.engine.SocketLifecycleManager
...
io.mazewall.profiler.engine.RealProfilerTransport .u.|> io.mazewall.profiler.engine.TraceEventPublisher
io.mazewall.profiler.engine.RealProfilerTransport .u.|> io.mazewall.profiler.engine.SeccompResponder
io.mazewall.profiler.engine.RealProfilerTransport .u.|> io.mazewall.profiler.engine.NativeIoOperations
io.mazewall.profiler.engine.RealProfilerTransport .u.|> io.mazewall.profiler.engine.SocketLifecycleManager
io.mazewall.profiler.engine.RealProfilerTransport --> io.mazewall.profiler.engine.RealProfilerTransport
io.mazewall.profiler.engine.SessionEventLedger --> io.mazewall.profiler.engine.SessionEvent
io.mazewall.profiler.engine.SyscallPathResolver --> io.mazewall.profiler.engine.SessionEventLedger
...
io.mazewall.profiler.internal.ProfilerTraceListener --> io.mazewall.profiler.engine.SyscallEvent
