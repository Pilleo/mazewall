...
**Target:** `io.mazewall.profiler.strace.StraceProfiler`, `docs/internals/designs/profiler/profiler-design.md`
**Context:** The `designs/profiler/profiler-design.md` document claims that Tier P (`StraceProfiler`) natively captures paths and async execution of `io_uring` (stating "Tier P (Root) | Paths and async captured natively"). This is fundamentally impossible under the current implementation and kernel constraints.
