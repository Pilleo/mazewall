...
**Target:** `io.mazewall.enforcer.ContainedExecutors` and `docs/internals/architecture/security-considerations.md`
...
**Needed:**
1. Document this fundamental architectural bypass clearly in `architecture/security-considerations.md` alongside the ACE pivot. Emphasize that Tier 2 containment only restricts synchronous execution on the current thread.
