...
The shift to **contracts** (BoB) introduces **internal enforcement boundaries**, where the OS kernel validates every system call against a specific behavioral profile.
