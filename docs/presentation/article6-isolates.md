...
The JVM process-portal design (pooled workers, data + broker→worker FDs, KotlinPoet later) is [process-portal-design.md](../internals/designs/enforcer/process-portal-design.md). Runtime and codegen are not implemented yet.
