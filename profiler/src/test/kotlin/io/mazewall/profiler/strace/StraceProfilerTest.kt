...
class StraceProfilerTest {
    ...
    fun `test that StraceProfiler and Profiler contain TOCTOU KDoc documentation`() {
        ...
        org.junit.jupiter.api.Assertions
            .assertTrue(profilerFile.exists(), "Profiler.kt should be found at ${profilerFile.absolutePath}")
        org.junit.jupiter.api.Assertions
            .assertTrue(straceProfilerFile.exists(), "StraceProfiler.kt should be found at ${straceProfilerFile.absolutePath}")
        org.junit.jupiter.api.Assertions
            .assertTrue(profilerDaemonFile.exists(), "ProfilerDaemon.kt should be found at ${profilerDaemonFile.absolutePath}")
        ...
        org.junit.jupiter.api.Assertions
            .assertTrue(profilerContent.contains("TOCTOU"), "Profiler.kt should document TOCTOU")
        org.junit.jupiter.api.Assertions
            .assertTrue(profilerContent.contains("Landlock"), "Profiler.kt should document Landlock")

        org.junit.jupiter.api.Assertions
            .assertTrue(straceProfilerContent.contains("TOCTOU"), "StraceProfiler.kt should document TOCTOU")
        org.junit.jupiter.api.Assertions
            .assertTrue(straceProfilerContent.contains("Landlock"), "StraceProfiler.kt should document Landlock")

        org.junit.jupiter.api.Assertions
            .assertTrue(profilerDaemonContent.contains("TOCTOU"), "ProfilerDaemon.kt should document TOCTOU")
        org.junit.jupiter.api.Assertions
            .assertTrue(profilerDaemonContent.contains("Landlock"), "ProfilerDaemon.kt should document Landlock")
    }
}
