...
public object ElfSymbolOffset {
    public fun resolve(path: Path, symbol: String): Long = resolve(Files.readAllBytes(path), symbol)

    public fun resolve(image: ByteArray, symbol: String): Long {
    ...
    private fun virtualAddressToOffset(elf: ByteBuffer, imageSize: Int, address: Long): Long {
