...
public object InvocationProtocol {
    ...
    public fun encode(event: InvocationEvent): ByteArray {
        ...
        return ByteBuffer.allocate(HEADER_SIZE + COMMON_SIZE + payloadSize)
    ...
    private fun requireRemaining(buffer: ByteBuffer, expected: Int) {
