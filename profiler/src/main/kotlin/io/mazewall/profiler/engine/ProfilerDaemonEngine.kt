 ...
 */
// @ref: docs/internals/profiler_design.md — USER_NOTIF ACK loop protocol, deadlock prevention, SCM_RIGHTS socket FD transfer
// @ref: docs/internals/architectural_map.md — Profiler-Enforcer ACK loop sequence diagram
