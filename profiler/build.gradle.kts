...
abstract class GenerateInvocationStateBtf @Inject constructor(
    ...
    fun generate() {
        ...
        resource.get().asFile.parentFile.mkdirs()
        execOperations.exec {
...
val generateInvocationStateBtf = tasks.register<GenerateInvocationStateBtf>("generateInvocationStateBtf") {
