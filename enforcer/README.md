...
For a detailed class hierarchy and structural relationship map, see the [Enforcer Module Architecture documentation](../docs/internals/designs/enforcer/enforcer-architecture.md).
