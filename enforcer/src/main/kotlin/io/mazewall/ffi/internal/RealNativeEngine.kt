...
internal object RealNativeMemory : NativeMemory {
    ...
    override fun newSockFProg(
        ...
        require(filters.size <= io.mazewall.ffi.NativeConstants.BPF_MAXINSNS) {
            "BPF program exceeds kernel maximum instruction limit of ${io.mazewall.ffi.NativeConstants.BPF_MAXINSNS} instructions"
        }
